...
const header = "// Code generated by sqlz. DO NOT EDIT.\n";
...
/// Ensure a name is a valid Zig identifier. Keywords and invalid chars get @"..." quoting.
fn safeIdentifier(allocator: std.mem.Allocator, name: []const u8) ![]const u8 {
    return query_mod.validateIdentifier(allocator, name) catch {
