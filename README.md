...
```sh
curl -fsSL https://raw.githubusercontent.com/ankitpatial/sqlz/main/install.sh | sh
```
...
```sh
git clone https://github.com/ankitpatial/sqlz.git
cd sqlz
zig build -Doptimize=ReleaseSafe
# copy zig-out/bin/sqlz somewhere on your PATH
```
...
sqlz check --src db/sql/ --dest db/query/
```
...
```zig
// Code generated by sqlz. DO NOT EDIT.
